...
return {
        ...
        opts = {
            ...
            textobjects = {
                select = {
                    ...
                    lookahead = true,
                    keymaps = {
                        ["ak"] = { query = "@block.outer", desc = "TS: around block" },
                        ["ik"] = { query = "@block.inner", desc = "TS: inside block" },
                        ["ac"] = { query = "@class.outer", desc = "TS: around class" },
                        ["ic"] = { query = "@class.inner", desc = "TS: inside class" },
                        ["a?"] = { query = "@conditional.outer", desc = "TS: around conditional" },
                        ["i?"] = { query = "@conditional.inner", desc = "TS: inside conditional" },
                        ...
                        ["aa"] = { query = "@parameter.outer", desc = "TS: around argument" },
                        ["ia"] = { query = "@parameter.inner", desc = "TS: inside argument" },
                    },
                },
                move = {
                    enable = true,
                    set_jumps = true,
                    goto_next_start = {
                        ["}k"] = { query = "@block.outer", desc = "TS: Next block start" },
                        ["}f"] = { query = "@function.outer", desc = "TS: Next function start" },
                        ["}a"] = { query = "@parameter.inner", desc = "TS: Next parameter start" },
                    },
                    goto_next_end = {
                        ["}K"] = { query = "@block.outer", desc = "TS: Next block end" },
                        ["}F"] = { query = "@function.outer", desc = "TS: Next function end" },
                        ["}A"] = { query = "@parameter.inner", desc = "TS: Next parameter end" },
                    },
                    goto_previous_start = {
                        ["{k"] = { query = "@block.outer", desc = "TS: Previous block start" },
                        ["{f"] = { query = "@function.outer", desc = "TS: Previous function start" },
                        ["{a"] = { query = "@parameter.inner", desc = "TS: Previous parameter start" },
                    },
                    goto_previous_end = {
                        ["{K"] = { query = "@block.outer", desc = "TS: Previous block end" },
                        ["{F"] = { query = "@function.outer", desc = "TS: Previous function end" },
                        ["{A"] = { query = "@parameter.inner", desc = "TS: Previous parameter end" },
                    },
                },
                swap = {
                    enable = true,
                    swap_next = {
                        [">K"] = { query = "@block.outer", desc = "TS: Swap next block" },
                        [">F"] = { query = "@function.outer", desc = "TS: Swap next function" },
                        [">A"] = { query = "@parameter.inner", desc = "TS: Swap next parameter" },
                    },
                    swap_previous = {
                        ["<K"] = { query = "@block.outer", desc = "TS: Swap previous block" },
                        ["<F"] = { query = "@function.outer", desc = "TS: Swap previous function" },
                        ["<A"] = { query = "@parameter.inner", desc = "TS: Swap previous parameter" },
                    },
                },
            },
        },
    ...
    --  https://github.com/stevearc/aerial.nvim
    {
        ...
        opts = {
            ...
            keymaps = {
                ["{y"] = "aerial: actions.prev",
                ["}y"] = "aerial: actions.next",
                ["{Y"] = "aerial: actions.prev_up",
                ["}Y"] = "aerial: actions.next_up",
                ["{"] = false,
                ["}"] = false,
                ["[["] = false,
                ["]]"] = false,
